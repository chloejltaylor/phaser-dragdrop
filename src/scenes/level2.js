...
{{                //set interactive vehicle feature
        ...
        let object2 = this.add.image(startX2, startY2, 'decoy1')
        let object3 = this.add.image(startX3, startY3, 'decoy2')
        let object4 = this.add.image(startX4, startY4, 'decoy3')
